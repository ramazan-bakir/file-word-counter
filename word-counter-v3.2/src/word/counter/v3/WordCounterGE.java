...
public class WordCounterGE extends javax.swing.JFrame {
    public WordCounterGE() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Datei aussuchen");
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        fc.setDialogTitle("Wählen Sie Datei");
        returnVal = fc.showDialog(this, "Wählen");
        ...
        txtsonuc.setText("Ungültiges Format");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WordCounterGE().setVisible(true);
            }
        });
    }
